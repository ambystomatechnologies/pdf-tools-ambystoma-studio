...
const I18N_DICTIONARY = {
  en: {
    ...
    toast_invalid_images: "Please select valid image files (JPG, PNG, WebP, BMP).",
  ...
  es: {
    ...
    toast_invalid_images: "Por favor selecciona archivos de imagen válidos (JPG, PNG, WebP, BMP).",
